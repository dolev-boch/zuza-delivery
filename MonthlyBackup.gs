...
const BACKUP_PRODUCT_ROW_MAP = {
  ...
  salty_empty_cheese_bourekas: { row: 22, name: 'בורקס גבינה ריק', category: 'מלוחים' },
  salty_rectangle_pastry: { row: 23, name: 'מאפה מלוח (מלבן)', category: 'מלוחים' },
  salty_focaccia_squares: { row: 24, name: "ריבועי פוקאצ'ה", category: 'מלוחים' },
  salty_personal_focaccia: { row: 25, name: "פוקאצ'ה אישית", category: 'מלוחים' },
  salty_quiche_10: { row: 26, name: 'קיש ק.10', category: 'מלוחים' },
  salty_bagelson: { row: 27, name: 'בייגלסון', category: 'מלוחים' },
  salty_brioche_challah: { row: 28, name: 'חלות בריוש', category: 'מלוחים' },
  salty_bread_loaf: { row: 29, name: 'כיכר לחם', category: 'מלוחים' },
  salty_cheese_saviach: { row: 30, name: 'מאפה גבינות וסביח', category: 'מלוחים' },
  salty_cheese_spinach: { row: 31, name: 'מאפה גבינה ותרד', category: 'מלוחים' },
  salty_poppy_bun: { row: 32, name: 'לחמניית פרג', category: 'מלוחים' },
  salty_pretzel: { row: 33, name: 'פרעצל', category: 'מלוחים' },

  // Sandwiches - כריכים (rows 34-41)
  sandwiches_beet_sourdough: { row: 34, name: 'מחמצת סלק', category: 'כריכים' },
  sandwiches_eggplant_sourdough: { row: 35, name: 'מחמצת חצילים', category: 'כריכים' },
  sandwiches_brioche_poppy_camembert: { row: 36, name: 'בריוש פרג קממבר', category: 'כריכים' },
  sandwiches_bourekas_cheeses: { row: 37, name: 'כריך בורקס גבינות', category: 'כריכים' },
  sandwiches_croissant_butter: { row: 38, name: 'כריך קרואסון חמאה', category: 'כריכים' },
  sandwiches_bagel: { row: 39, name: 'כריך בייגל', category: 'כריכים' },
  sandwiches_focaccia: { row: 40, name: "כריך פוקאצ'ה", category: 'כריכים' },
  sandwiches_scrambled_bun: { row: 41, name: 'לחמניה מקושקשת', category: 'כריכים' },

  // Shelf products - מוצרי מדף (rows 42-44)
  shelf_yeast_cake: { row: 42, name: 'עוגת שמרים', category: 'מוצרי מדף' },
  shelf_challah: { row: 43, name: 'חלות', category: 'מוצרי מדף' },
  shelf_thick: { row: 44, name: 'בחושות', category: 'מוצרי מדף' },

  // Whole cakes - עוגות שלמות (rows 45-55)
  whole_cakes_fudge_mascarpone_strip: { row: 45, name: "פס פאדג' מסקרפונה", category: 'עוגות שלמות' },
  whole_cakes_rusha_hazelnut_strip: { row: 46, name: 'פס רושה אגוזי לוז', category: 'עוגות שלמות' },
  whole_cakes_mango_passionfruit_strip: { row: 47, name: 'פס מנגו פסיפלורה', category: 'עוגות שלמות' },
  whole_cakes_coffee_pecan_strip: { row: 48, name: 'פס קפה פקאן', category: 'עוגות שלמות' },
  whole_cakes_tricolor_20: { row: 49, name: 'טריקולד ק.20', category: 'עוגות שלמות' },
  whole_cakes_pistachio_berry_20: { row: 50, name: 'פיסטוק פירות יער ק.20', category: 'עוגות שלמות' },
  whole_cakes_cheese_crumbs_20: { row: 51, name: 'גבינה פירורים ק.20', category: 'עוגות שלמות' },
  whole_cakes_baked_cheese_20: { row: 52, name: 'גבינה אפויה ק.20', category: 'עוגות שלמות' },
  whole_cakes_rusha_hazelnut_square: { row: 53, name: 'ריבוע רושה אגוזי לוז', category: 'עוגות שלמות' },
  whole_cakes_coffee_pecan_square: { row: 54, name: 'ריבוע קפה פקאן', category: 'עוגות שלמות' },
  whole_cakes_chocolate_fudge: { row: 55, name: "פאדג' שוקולד", category: 'עוגות שלמות' },

  // Vitrina desserts - קינוחי ויטרינה (rows 56-67)
  vitrina_cashew_dolce: { row: 56, name: "קשיו דולצ'ה", category: 'קינוחי ויטרינה' },
  vitrina_pistachio_berry: { row: 57, name: 'פיסטוק פירות יער', category: 'קינוחי ויטרינה' },
  vitrina_pheasant_vanilla_raspberry: { row: 58, name: 'פחזנית וניל פטל', category: 'קינוחי ויטרינה' },
  vitrina_sabla_pecan: { row: 59, name: 'סבלה פקאן', category: 'קינוחי ויטרינה' },
  vitrina_fruit_tart: { row: 60, name: 'טארט פירות', category: 'קינוחי ויטרינה' },
  vitrina_lemon_tart_100: { row: 61, name: 'טארט לימון 100%', category: 'קינוחי ויטרינה' },
  vitrina_chocolate_100: { row: 62, name: '100 אחוז שוקולד', category: 'קינוחי ויטרינה' },
  vitrina_rusha_hazelnut: { row: 63, name: 'רושה אגוזי לוז', category: 'קינוחי ויטרינה' },
  vitrina_paris_brest: { row: 64, name: 'פריז ברסט', category: 'קינוחי ויטרינה' },
  vitrina_chocolate_ball: { row: 65, name: 'כדור שוקולד', category: 'קינוחי ויטרינה' },
  vitrina_personal_pheasant_vanilla: { row: 66, name: 'פחזנית וניל אישית', category: 'קינוחי ויטרינה' },
  vitrina_chocolate_fudge: { row: 67, name: "פאדג' שוקולד", category: 'קינוחי ויטרינה' },

  // Cookies - עוגיות (rows 68-78)
  cookies_florentine: { row: 68, name: 'פלורנטין', category: 'עוגיות' },
  cookies_coffee_almonds: { row: 69, name: 'קפה שקדים', category: 'עוגיות' },
  cookies_almonds_lemon: { row: 70, name: 'שקדים לימון', category: 'עוגיות' },
  cookies_pecan: { row: 71, name: 'פקאן', category: 'עוגיות' },
  cookies_brownies: { row: 72, name: 'בראוניז', category: 'עוגיות' },
  cookies_butter_hazelnut: { row: 73, name: 'חמאה לוז', category: 'עוגיות' },
  cookies_parmesan: { row: 74, name: 'פרמזן', category: 'עוגיות' },
  cookies_dates: { row: 75, name: 'עוגיות תמרים', category: 'עוגיות' },
  cookies_alfajores: { row: 76, name: 'אלפחורס', category: 'עוגיות' },
  cookies_pistachio_lag_baomer: { row: 77, name: 'פיסטוק לל"ג', category: 'עוגיות' },
  cookies_cocoa_chocolate: { row: 78, name: 'קקאו שוקולד', category: 'עוגיות' },

  // Various products - מוצרים שונים (rows 79-87)
  various_mushroom_pastry: { row: 79, name: 'מאפה פטריות', category: 'מוצרים שונים' },
  various_cheese_berry_pastry: { row: 80, name: 'מאפה גבינה ופירות יער', category: 'מוצרים שונים' },
  various_basque_cheesecake: { row: 81, name: 'עוגת גבינה באסקית', category: 'מוצרים שונים' },
  various_yolk_pasteurized: { row: 82, name: 'חלמון מפוסטר', category: 'מוצרים שונים' },
  various_parmesan_raw: { row: 83, name: 'פרמזן חומר גלם', category: 'מוצרים שונים' },
  various_sweet_cream: { row: 84, name: 'שמנת מתוקה', category: 'מוצרים שונים' },
  various_butter: { row: 85, name: 'חמאה', category: 'מוצרים שונים' },
  various_pistachio_berry_strip: { row: 86, name: 'פס פיסטוק פירות יער', category: 'מוצרים שונים' },
  various_pressburger_poppy: { row: 87, name: 'פרסבורגר פרג', category: 'מוצרים שונים' },
};
...
const BACKUP_CUSTOM_PRODUCTS_START_ROW = 88; // Row 87 is last regular product, 88+ for אחרים
